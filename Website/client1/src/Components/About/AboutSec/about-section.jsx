          ...
          <div className="flex flex-wrap lg:justify-start justify-between items-center py-3 text-sm">
            ...
            <div className="lg:absolute right-0 bottom-16 flex lg:flex-col flex-row-reverse lg:gap-0 gap-4">
              <div className="flex lg:text-4xl sm:text-3xl text-2xl items-center gap-2 mb-2">
                ...
                <span className="text-gray-600 uppercase">elevated</span>
              </div>
              <div className="flex items-center gap-2 mb-2 sm:text-base text-xs">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="md:col-span-1">
            <div className="text-right">
              ...
              <button className="bg-neutral-900 hover:bg-neutral-950 shadow-lg shadow-neutral-900 border border-neutral-700 flex w-fit ml-auto gap-2 hover:gap-4 transition-all duration-300 ease-in-out text-white px-5 py-3 rounded-lg cursor-pointer font-semibold">

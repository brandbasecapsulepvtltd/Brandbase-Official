...
const FloatingWhatsApp = () => {
  ...
  return (
    <>
      ...
      {/* QR Code Box */}
      {showQR && !isMobile && (
        <div className="fixed bottom-30 right-6 z-50 w-64 p-4 bg-white rounded-2xl shadow-2xl border border-gray-200">
          <h4 className="text-lg font-semibold mb-3 text-center text-gray-800">
            Scan to Chat
          </h4>

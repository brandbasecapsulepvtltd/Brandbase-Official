  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-zinc-950 dark:to-black">
      ...
      <motion.section
        ...
        animate="visible"
        variants={fadeInUp}
        className="relative overflow-hidden bg-gradient-to-r from-orange-50 to-white dark:from-orange-950/20 dark:to-black pt-24 pb-12 md:py-20 mt-5"
      >
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex flex-col sm:flex-row items-center gap-2 sm:gap-3 bg-white dark:bg-zinc-900 rounded-lg px-6 py-3 shadow-sm border border-gray-200 dark:border-zinc-800">
              ...
              <span className="text-gray-900 dark:text-white font-semibold text-sm">{privacyPolicyData.lastUpdated}</span>
            </div>
          </div>
        </div>
      </motion.section>
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                              <div>
                                <div className="flex items-center gap-3 mb-6">
                                  ...
                                  <div>
                                    <h3 className="text-lg md:text-xl font-bold text-gray-900 dark:text-white">{point.contact.company}</h3>
                                    <p className="text-sm text-gray-600 dark:text-gray-400">{point.contact.tagline}</p>
                                  </div>
                                </div>
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div className="min-w-0 flex-1">
                                    ...
                                    <span className="text-gray-900 dark:text-white text-sm md:text-base font-medium">{point.contact.phone}</span>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  <div className="min-w-0 flex-1">
                                    ...
                                    <span className="text-gray-900 dark:text-white text-sm md:text-base block">{point.contact.address}</span>
                                  </div>
                                </div>
                              </div>
                            </div>

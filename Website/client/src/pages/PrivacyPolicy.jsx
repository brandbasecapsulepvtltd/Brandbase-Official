...
const privacyPolicyData = {
  ...
  sections: [
    ...
    },
    {
      ...
      note: `To exercise these rights, contact our Data Protection Officer at <a href="mailto:privacy@brandbasecapsule.com" class="text-orange-600 hover:text-orange-700 font-semibold transition-colors">privacy@brandbasecapsule.com</a>.`,
    },
    {
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="inline-flex items-center gap-3 bg-white rounded-lg px-6 py-3 shadow-sm border border-gray-200">
              ...
              <span className="text-gray-900 font-semibold">{privacyPolicyData.lastUpdated}</span>
            </div>
          </div>
        </div>
      </motion.section>
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        ...
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">Our Privacy Philosophy</h2>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 hover:border-orange-200 transition-colors duration-300">
                ...
                <div className="p-8">
                  <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                              <div>
                                <div className="flex items-center gap-3 mb-6">
                                  ...
                                  <div>
                                    <h3 className="text-xl font-bold text-gray-900">{point.contact.company}</h3>
                                    <p className="text-gray-600">{point.contact.tagline}</p>
                                  </div>
                                </div>
                              ...
                              <div className="space-y-4">
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    <p className="text-sm text-gray-500">Privacy Concerns</p>
                                    <a 
                                ...
                                <div className="flex items-center gap-3">
                                  ...
                                  <div>
                                    ...
                                    <span className="text-gray-900 font-medium">{point.contact.phone}</span>
                                  </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                  ...
                                  <div>
                                    ...
                                    <span className="text-gray-900">{point.contact.address}</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                    ...
                    {section.note && (
                      <div className="mt-6 p-6 bg-orange-50/50 rounded-xl border border-orange-200">
                        <div className="flex items-start gap-3">

...
export default function MapDemo() {
  return (
    <div className="py-40 bg-white dark:bg-zinc-900 dark:bg-black w-full">
     <div className="max-w-7xl mx-auto text-center">
  <p className="font-bold text-xl md:text-5xl text-orange-500">
    Worldwide Presence
  </p>
  <p className="text-sm md:text-xl text-gray-900 dark:text-gray-100 dark:text-gray-100 max-w-3xl mx-auto py-4">

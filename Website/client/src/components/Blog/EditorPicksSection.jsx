  ...
  return (
    <section className="bg-white dark:bg-zinc-900 dark:bg-black py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Title */}
        <h2 className="text-4xl md:text-5xl font-semibold mb-10 md:mb-12 text-gray-900 dark:text-gray-100 dark:text-gray-100">
          Editor's picks
        </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <a href={`/blogs/${mainPick.metadata.category}/${mainPick.metadata.slug}`} className="group block h-full">
              ...
              {/* Text Content */}
              <p className="text-sm font-semibold text-gray-500 dark:text-gray-400 mb-1">ARTICLE</p>
              <h3 className="text-2xl md:text-4xl font-bold mb-3 leading-snug text-gray-900 dark:text-gray-100 dark:text-gray-100 group-hover:text-indigo-600 transition duration-300">
              ...
              <React.Fragment key={index}>
                ...
                <a href={`/blogs/${pick.metadata.category}/${pick.metadata.slug}`} className="group flex items-start pt-8">
                  ...
                  <div>
                    ...
                    <h3 className="text-lg font-bold mb-1 leading-tight text-gray-900 dark:text-gray-100 dark:text-gray-100 group-hover:text-indigo-600 transition duration-300">
                      {pick.metadata.title}
                    </h3>

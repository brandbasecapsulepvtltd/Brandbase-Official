...
const WebHeroSection = ({ data }) => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-zinc-900 dark:bg-black font-sans flex flex-col items-center justify-center mt-10">
          ...
          <div className="flex animate-scroll whitespace-nowrap">
            {loopFeatures.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex items-center gap-2 px-5 py-2.5 bg-white dark:bg-zinc-900 dark:bg-black border border-slate-200 rounded-xl shadow-sm mx-2"
                >

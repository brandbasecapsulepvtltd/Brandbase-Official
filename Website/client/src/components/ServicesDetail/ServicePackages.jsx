...
const ServicePackages = ({ data }) => {
  ...
  return (
    <section className="w-full bg-white py-20 px-4 sm:px-6 md:px-12 font-sans">
      <div className="max-w-7xl mx-auto overflow-hidden">

        {/* HEADER */}
        <div className="text-center mb-12 md:mb-16 space-y-4">
          <h2 className="text-3xl sm:text-4xl md:text-6xl text-gray-800 leading-tight">
          ...
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-start h-full">
                ...
                {/* IMAGE */}
                <div className="relative h-[280px] sm:h-[350px] md:h-[450px] lg:h-[500px] w-full rounded-[2rem] overflow-hidden bg-gray-100 shadow-sm">
                  <img
                ...
                <div className="pt-2 sm:pt-4 space-y-6 sm:space-y-8">
                  ...
                  <h3 className="text-3xl sm:text-4xl font-normal text-gray-900">
                    {activePackage.title}
                  </h3>

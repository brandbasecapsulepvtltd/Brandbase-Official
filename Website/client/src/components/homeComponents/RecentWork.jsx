...
export default function RecentWork() {
  return (
    <section 
      ...
      className="py-8 sm:py-12 md:py-16 px-4 sm:px-6 lg:px-8 xl:px-10 bg-white"
    >
      <div className="container mx-auto max-w-7xl">
        ...
        <header className="mb-8 sm:mb-10 md:mb-12 text-center lg:text-left">
          ...
          <h1 
            ...
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-medium mt-3 sm:mt-4 leading-tight text-black"
          >
            Work We're Proud Of
          </h1>
        </header>

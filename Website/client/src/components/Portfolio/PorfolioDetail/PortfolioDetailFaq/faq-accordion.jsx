...
const CustomAccordionTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex">
    ...
    >
      ...
      <div className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-full bg-gray-200 dark:bg-zinc-700 transition-transform group-hover:scale-105 group-data-[state=open]:rotate-180">
...
const CustomAccordionContent = React.forwardRef(({ className, children, ...props }, ref) => (
  ...
  >
    <div className="mt-4 ml-14">
      <div className="flex items-start gap-4 rounded-2xl bg-white dark:bg-zinc-800/80 p-4 shadow-md transition-all border border-transparent dark:border-zinc-700/30">
        <span className="flex-1 text-md leading-relaxed">{children}</span>
        <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-gray-300/70 dark:bg-zinc-700 transition-transform hover:scale-105">

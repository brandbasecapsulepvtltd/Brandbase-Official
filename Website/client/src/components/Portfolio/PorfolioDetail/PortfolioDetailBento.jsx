    ...
    <div className="bg-white dark:bg-black min-h-screen p-8 flex flex-col items-center font-sans py-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl w-full">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-zinc-800/50 border border-gray-100 dark:border-zinc-800 rounded-3xl p-6 flex flex-col justify-between h-64 shadow-sm hover:shadow-md transition-shadow relative group">
            <h2 className="text-2xl font-medium text-gray-900 dark:text-white leading-tight w-3/4">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-[#222222] rounded-3xl p-6 flex flex-col justify-between h-64 relative group">
            ...
            <button className="w-10 h-10 bg-white dark:bg-zinc-800 rounded-full flex items-center justify-center text-black dark:text-white mt-auto group-hover:scale-110 transition-transform">
              <Plus size={20} />
            </button>
          </div>

          {/* Card 4: Amazing Work (Experience) */}
          <div className="bg-white dark:bg-zinc-800/50 border border-gray-100 dark:border-zinc-800 rounded-3xl p-6 flex flex-col justify-between h-64 shadow-sm relative overflow-hidden">
            <h2 className="text-2xl font-medium text-gray-900 dark:text-white leading-tight z-10 w-3/4">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="bg-white dark:bg-zinc-800/50 border border-gray-100 dark:border-zinc-800 rounded-3xl p-6 h-64 shadow-sm flex flex-col">
            <h3 className="text-xs font-bold text-gray-400 dark:text-zinc-500 uppercase tracking-wider mb-3">Our Expertise</h3>
            <ul className="overflow-y-auto pr-2 custom-scrollbar space-y-4 h-full">
              {services.map((service, index) => (
                <li key={index} className="text-gray-800 dark:text-gray-200 font-medium text-sm pb-3 border-b border-gray-100 dark:border-zinc-800 last:border-0 hover:text-[#222] dark:hover:text-white cursor-pointer transition-colors flex items-center justify-between">
                  {service}
                </li>
              ))}
            </ul>

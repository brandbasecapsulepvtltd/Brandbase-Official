export default function SuccessMessage({ onReset }) {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8f8f0] p-6 mt-15">
      <div className="bg-white dark:bg-black p-8 rounded-2xl shadow-lg border border-orange-100 text-center max-w-md w-full">
        ...
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 font-sans mb-2">Appointment Booked!</h2>

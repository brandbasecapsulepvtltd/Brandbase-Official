...
const EventPopup = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
      {/* Main Container */}
      <div className="relative flex flex-col md:flex-row w-full max-w-4xl bg-white dark:bg-zinc-900 dark:bg-black rounded-2xl overflow-hidden shadow-2xl animate-in fade-in zoom-in duration-300">
        
        {/* Close Button */}
        <button 
          onClick={() => setIsOpen(false)}
          className="absolute top-4 right-4 p-1 rounded-full bg-gray-100 text-gray-500 dark:text-gray-400 hover:bg-orange-100 hover:text-orange-500 transition-colors z-10"
        >
          <X size={20} />
        </button>
        ...
        {/* Right Side: Content */}
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-white dark:bg-zinc-900 dark:bg-black">
          <span className="text-orange-500 font-bold tracking-widest text-sm uppercase mb-2">
            Exhibition Season 2024-25
          </span>
          
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 dark:text-gray-100 leading-tight mb-4">

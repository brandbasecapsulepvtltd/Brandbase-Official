      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {data.services.map((service, index) => (
            <div
              key={index}
              className="group bg-orange-100 dark:bg-zinc-800/50 rounded-[32px] p-8 flex flex-col items-center text-center transition-all duration-300 h-full border border-gray-200 dark:border-zinc-700 hover:shadow-lg hover:shadow-orange-100/20 dark:hover:shadow-orange-950/20 relative overflow-hidden"
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-transparent to-indigo-50/10 dark:to-orange-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-[32px] pointer-events-none"></div>
            </div>
          ))}
        </div>
      </div>
